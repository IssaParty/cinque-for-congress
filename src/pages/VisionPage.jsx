  ...
  return (
    <main style={styles.contentPage}>
      <div style={styles.pageContainer}>
        <h1 style={styles.pageTitle}>Our Vision: A Cleaner, Safer, and Unified Republic</h1>
        <div style={styles.pageContent}>
          ...
          <section style={styles.contentSection}>
            <h2 style={styles.contentSubtitle}>The Costs of Corporate Power</h2>
            <p style={styles.contentText}>
          ...
          <section style={styles.contentSection}>
            <h2 style={styles.contentSubtitle}>Restoring Economic Freedom</h2>
            <p style={styles.contentText}>
          ...
          <section style={styles.contentSection}>
            <h2 style={styles.contentSubtitle}>A Path Beyond Politics as Usual</h2>
            <p style={styles.contentText}>
          ...
          <section style={styles.contentSection}>
            <h2 style={styles.contentSubtitle}>Why Age and Experience Are Strengths, Not Barriers</h2>
            <p style={styles.contentText}>
          ...
          <section style={styles.contentSection}>
            <h2 style={styles.contentSubtitle}>A Vision for True Representation</h2>
            <p style={styles.contentText}>
